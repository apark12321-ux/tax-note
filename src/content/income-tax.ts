...
`,
  ...
  {
    id: "income-4",
    title: "종합소득세 신고 마감 임박 — 깜빡했다면 가산세 줄이는 법 (2026년)",
    excerpt:
...
<div class="toc">
  <p><strong>목차</strong></p>
  <ul>
    <li><a href="#section1">2026년 신고 마감일</a></li>
    <li><a href="#section2">기한을 놓치면 붙는 가산세</a></li>
    <li><a href="#section3">기한 후 신고 감면</a></li>
    <li><a href="#section4">마감 직전 체크리스트</a></li>
    <li><a href="#section5">환급 대상자도 신고하세요</a></li>
  </ul>
</div>

<h2>아직 신고 전이라면 지금이 중요합니다</h2>
<p>5월도 막바지에 접어들었습니다. 종합소득세 신고를 미뤄두고 있었다면 지금이 마지막 점검 시점입니다. 혹시 기한을 넘겼더라도 방법은 있습니다. 자발적으로 빨리 신고할수록 가산세를 크게 줄일 수 있기 때문입니다. 마감을 앞둔 분과 이미 놓친 분 모두를 위해 정리하겠습니다.</p>

<h3 id="section1">2026년 신고 마감일</h3>
<p>2026년 종합소득세 신고·납부 기한은 <strong>6월 1일(월)까지</strong>입니다. 원래 5월 31일이 법정 기한이지만, 그날이 일요일이라 다음 날인 6월 1일로 연장되었습니다. 성실신고확인 대상자는 6월 30일까지입니다. 이 기한 안에 신고와 납부를 모두 마쳐야 가산세가 붙지 않습니다.</p>

<h3 id="section2">기한을 놓치면 붙는 가산세</h3>
<p>기한 내 신고하지 않으면 크게 두 가지 가산세가 더해집니다.</p>
<ul>
  <li><strong>무신고가산세:</strong> 무신고 납부세액의 20%. 단순 실수가 아니라 부정한 방법으로 신고하지 않은 경우에는 40%까지 올라갑니다. 복식부기의무자는 '수입금액의 0.07%'와 '납부세액의 20%' 중 큰 금액이 적용됩니다.</li>
  <li><strong>납부지연가산세:</strong> 내야 할 세금에 하루당 0.022%씩 붙습니다. 1년으로 환산하면 약 8% 수준이라, 늦어질수록 빠르게 불어납니다.</li>
</ul>
<p>여기에 종합소득세의 10%인 지방소득세도 함께 납부해야 한다는 점을 잊지 마세요.</p>

<h3 id="section3">기한 후 신고 감면</h3>
<p>좋은 소식은, 기한을 넘겼더라도 세무서가 무신고를 확정해 통지하기 전에 스스로 신고하면 무신고가산세를 감면받을 수 있다는 점입니다. 빨리 할수록 감면 폭이 큽니다.</p>
<ul>
  <li><strong>1개월 이내:</strong> 무신고가산세 50% 감면</li>
  <li><strong>1개월 초과 ~ 3개월 이내:</strong> 30% 감면</li>
  <li><strong>3개월 초과 ~ 6개월 이내:</strong> 20% 감면</li>
</ul>
<p>다만 납부지연가산세는 이런 감면과 별개로 늦은 일수만큼 계속 쌓입니다. 그래서 "어차피 늦었으니 천천히"가 아니라, 하루라도 빨리 신고·납부하는 것이 최선입니다.</p>

<h3 id="section4">마감 직전 체크리스트</h3>
<p>아직 신고 전이라면 다음을 빠르게 점검하세요.</p>
<ul>
  <li>홈택스 신고도움 서비스에서 본인 귀속 소득자료 확인</li>
  <li>인적공제 대상 가족, 빠진 사람은 없는지</li>
  <li>연금저축·IRP, 노란우산공제 납입 내역 반영 여부</li>
  <li>사업자라면 경비 증빙(세금계산서·카드·현금영수증) 정리</li>
  <li>납부할 세액이 크다면 분납 가능 여부 확인</li>
</ul>
...
`,
  ...
  {
    id: "income-5",
    title: "종합소득세 환급과 분납, 알아두면 부담이 줄어듭니다",
    excerpt:
      "낼 세금이 크면 나눠 낼 수 있고, 더 낸 세금은 돌려받습니다. 종합소득세 환급 시기와 분납 조건, 납부 방법을 정리했습니다.",
    category: "종합소득세",
    author: "절세노트 편집팀",
    date: "2026-05-24",
    image:
...
<div class="toc-minimal">
  <p><strong>한눈에 보기</strong></p>
  <ul>
    <li><a href="#section1">환급은 언제 받나</a></li>
    <li><a href="#section2">세금이 클 때, 분납</a></li>
    <li><a href="#section3">납부 방법</a></li>
    <li><a href="#section4">환급금 조회와 주의점</a></li>
  </ul>
</div>

<h2>한 번에 다 내지 않아도 됩니다</h2>
<p>종합소득세를 신고하고 나면 두 가지 상황이 생깁니다. 더 낸 세금을 돌려받거나, 더 낼 세금이 생기거나입니다. 환급이라면 반가운 일이고, 납부할 세액이 크다면 부담이 되지만 나눠 낼 방법이 있습니다. 두 경우 모두 알아두면 자금 계획에 도움이 됩니다.</p>

<h3 id="section1">환급은 언제 받나</h3>
<p>미리 낸 세금(원천징수된 3.3%, 중간예납 등)이 실제 산출세액보다 많으면 차액을 환급받습니다. 특히 경비나 공제가 많은 프리랜서는 환급 대상인 경우가 흔합니다. 환급금은 신고 후 일정 기간(보통 신고기한 종료 후 약 한 달 전후)에 본인 계좌로 지급됩니다. 신고 시 환급받을 계좌를 정확히 입력하는 것이 중요합니다.</p>

<h3 id="section2">세금이 클 때, 분납</h3>
<p>반대로 납부할 세액이 크면 한 번에 내기 부담스럽습니다. 이때 분납 제도를 활용할 수 있습니다. 납부할 세액이 일정 금액(1,000만 원)을 초과하면, 일부를 납부기한 경과 후 일정 기간 내에 나눠 낼 수 있습니다.</p>
<ul>
  <li><strong>납부세액 2,000만 원 이하:</strong> 1,000만 원을 초과하는 금액을 분납</li>
  <li><strong>납부세액 2,000만 원 초과:</strong> 세액의 50% 이하를 분납</li>
</ul>
<p>분납을 신청하면 당장의 자금 압박을 줄일 수 있으니, 세액이 크다면 신고 시 분납 여부를 함께 검토하세요.</p>

<h3 id="section3">납부 방법</h3>
<p>종합소득세 납부는 여러 방법으로 할 수 있습니다.</p>
<ul>
  <li>홈택스·손택스에서 계좌이체나 신용카드로 전자납부</li>
  <li>금융기관 방문 납부</li>
  <li>가상계좌 이체</li>
</ul>
<p>신용카드 납부 시에는 별도의 납부대행 수수료가 발생할 수 있다는 점을 참고하세요. 종합소득세의 10%인 지방소득세도 함께 납부해야 합니다.</p>

<h3 id="section4">환급금 조회와 주의점</h3>
<p>환급금은 홈택스에서 지급 상태를 조회할 수 있습니다. 예상보다 지급이 늦어지면 계좌 정보 오류나 추가 확인 절차 때문일 수 있으니 조회로 확인하는 것이 좋습니다. 한편, 환급을 노리고 경비나 공제를 사실과 다르게 부풀리면 나중에 추징과 가산세 대상이 되므로, 환급은 어디까지나 정당한 신고의 결과여야 합니다. 자세한 납부·환급 안내는 <a href="https://hometax.go.kr" target="_blank" rel="noopener noreferrer">홈택스(hometax.go.kr)</a>에서 확인할 수 있습니다.</p>

<p class="text-sm text-gray-500 mt-8">※ 본 글은 2026년 기준 일반 정보이며 세무 상담을 대체하지 않습니다. 분납 기준과 환급 시기는 상황에 따라 다르므로, 구체적 사항은 홈택스 또는 세무 전문가와 확인하시기 바랍니다.</p>
<p class="text-xs text-gray-400 mt-2">최종 업데이트: 2026-05-24</p>
`,
  },
];
